...
Understanding-oriented compass for `@demlik/tea`. The decisions themselves live in the repo-wide [`.decisions/`](../../../../.decisions/index.md) — one global ADR sequence for the whole monorepo. This quadrant does not hold ADR files; it links out to the tea-scoped ones.
...
- [ADR 0010 — Export-map tiers: kernel/battery/experimental](../../../../.decisions/0010-export-map-tiers.md) — how the package's public surface is tiered, and what stays off the map.
- [ADR 0011 — Errors are data; a throw is reserved for a contract breach](../../../../.decisions/0011-errors-as-data.md) — the error idiom the library follows.
