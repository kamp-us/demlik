...
See `docs/design-patterns.md` ("Nullable Is Two Functions In Disguise", in the originating monorepo) — the rule that catches this at API-design time, before nullable propagates.
