...
// it at runtime; `A67`/`A68` close it at compile time for authors who want it.
...
/** The function form of a cell entry — see `A61`/`A67` for why it is a union. */
