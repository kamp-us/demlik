 ...
 *   upstream path:   packages/fabrika-cli/src/build/dependencies.ts
 *   upstream commit: 300faa48bee007db46adaa2141e6182ed3e5148b
 *
 * `emit.ts` reads its phase topology through this parser rather than growing a
 * second grammar, so vendoring the emitter means vendoring this too. Nothing in
 * `src/` proper imports it — it exists to make the emitter runnable.
 *
