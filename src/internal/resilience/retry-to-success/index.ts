/**
 * internal/resilience/retry-to-success — run a fallible async port through BOUNDED
 ...
 * leaf `retry-backoff` utility. Internal to the package
 * (`src/internal/resilience/`, #46), not a published subpath.
 */
